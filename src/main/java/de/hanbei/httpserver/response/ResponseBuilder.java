...
public class ResponseBuilder {
    ...
    public ResponseBuilder expires(Date expires) {
        response.getHeader().addParameter(Constants.EXPIRES, dateFormat.format(expires));
        return this;
    }
    ...
    public ResponseBuilder lastModified(Date lastModified) {
        response.getHeader().addParameter(Constants.LAST_MODIFIED, dateFormat.format(lastModified));
        return this;
    }
